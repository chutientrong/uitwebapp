    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-4 order-sm-1">
        ...
        <a class="d-inline-flex align-items-center mb-2" href="<?php echo base_url();?>">
          <img src="<?php echo base_url();?>uploads/frontend/<?php echo $footer_logo;?>" style="height:100px; width:100px;" />
          <span class="brand brand-primary">UIT VNU-HCM</span>
        </a>
        <!-- End Logo -->

        <div class="mb-4">
          <p class="small text-muted">© 2022, UIT VNU-HCM. All rights reserved.</p>
        </div>
