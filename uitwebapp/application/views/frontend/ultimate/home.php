...
<!--          space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1-->
          <div class="container text-center space-top-4 space-top-lg-3 space-bottom-1">
              <!-- Title -->
    ...
    <div class="u-hero-v1">
      ...
      <div class="js-slick-carousel u-slick"
        ...
        <div class="js-slide bg-img-hero-center"
             style=" background-image: url(<?php echo base_url(); ?>uploads/frontend/slider/<?php echo $slider_images[$i]->image;?>);">
          <div class="text-center space-3">
            <h2 class="text-dark font-weight-bold mb-2"
                data-scs-animation-in="fadeInUp" style="padding-top: 120px;">
              <?php echo $slider_images[$i]->title; ?>
            </h2>

            <p class="text-dark font-weight-light mx-auto w-50 d-none d-sm-block"
               data-scs-animation-in="fadeInUp"
               data-scs-animation-delay="200" style="font-weight: 50;">
