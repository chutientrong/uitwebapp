<div class="row">
    ...
    <div class="col-md-4">
		<blockquote class="blockquote-blue">
			<p>
				<strong>Hướng dẫn nhập học cho sinh viên</strong>
			</p>
			<p>
                Việc nhận học sinh mới sẽ tự động tạo đăng ký vào lớp đã chọn đang trong học kỳ.
                Vui lòng kiểm tra và kiểm tra lại các thông tin bạn đã chèn vì một khi bạn nhận học sinh mới, bạn sẽ không thể
                để chỉnh sửa lớp học, học phần của anh ấy / cô ấy mà không cần chuyển sang phiên tiếp theo.
			</p>
		</blockquote>
	</div>
