    ...
    <header class="logo-env" >
        ...
        <!-- <div class="logo" style="">
            <a href="<?php echo site_url('login'); ?>">
                <img src="<?php echo $system_name;?>"  style="max-height:30px;"/>
            </a>
        </div> -->
...
<!--            margin-left:10% !important;-->
            <img src="<?php echo base_url('uploads/logo.png');?>"  style="height:100px; width: 100px; align-content: center;"/>

            <h3 style="color: #fff;text-align:center;margin-bottom: 25px;font-weight: 600;margin-top: -25%;">
        ...
        <!-- Device -->
        <li class="<?php if ($page_name == 'device') echo 'active'; ?> " style="border-top:1px solid #232540;">
            <a href="<?php echo site_url('admin/device'); ?>">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('Quản Lý Thiết Bị'); ?></span>
            </a>
        </li>
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo get_phrase('Quản Lý Sinh Viên'); ?></span>
            </a>
            <ul>
                <!-- STUDENT ADMISSION -->
...
<!--                </li>-->
        ...
        <li class="<?php if ( $page_name == 'admin' ||
            ...
            <a href="#">
                ...
                <span><?php echo get_phrase('Quản Lý Người Dùng'); ?></span>
            </a>
            <ul>
                <!-- manage admins -->
